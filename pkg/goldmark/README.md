...
[![https://pkg.go.dev/uw/pkg/goldmark](https://pkg.go.dev/badge/uw/pkg/goldmark.svg)](https://pkg.go.dev/uw/pkg/goldmark)
[![https://uw/pkg/goldmark/actions?query=workflow:test](https://uw/pkg/goldmark/workflows/test/badge.svg?branch=master&event=push)](https://uw/pkg/goldmark/actions?query=workflow:test)
...
[![https://goreportcard.com/report/uw/pkg/goldmark](https://goreportcard.com/badge/uw/pkg/goldmark)](https://goreportcard.com/report/uw/pkg/goldmark)
...
- `extension.GFM`
    ...
    - If you need to parse github emojis, you can use [goldmark-emoji](https://uw/pkg/goldmark-emoji) extension.
...
You can use [goldmark-meta](https://uw/pkg/goldmark-meta) to define a id prefix in the markdown document:
...
- [goldmark-meta](https://uw/pkg/goldmark-meta): A YAML metadata
  extension for the goldmark Markdown parser.
- [goldmark-highlighting](https://uw/pkg/goldmark-highlighting): A syntax-highlighting extension
  for the goldmark markdown parser.
- [goldmark-emoji](https://uw/pkg/goldmark-emoji): An emoji
  extension for the goldmark Markdown parser.
