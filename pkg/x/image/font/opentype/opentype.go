...
// implementing the uw/pkg/x/image/font.Face interface.
//
// The sibling uw/pkg/x/image/font/sfnt package provides a low-level API.
package opentype // import "uw/pkg/x/image/font/opentype"
...
import (
	...
	"uw/pkg/x/image/font"
	"uw/pkg/x/image/font/sfnt"
	"uw/pkg/x/image/math/fixed"
	"uw/pkg/x/image/vector"
)
