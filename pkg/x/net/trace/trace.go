...
*/
package trace // import "uw/pkg/x/net/trace"
...
import (
	...
	"uw/pkg/x/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"uw/pkg/x/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of uw/pkg/x/net/trace.")
	}
...
var contextKey = contextKeyT("uw/pkg/x/net/trace.Trace")
