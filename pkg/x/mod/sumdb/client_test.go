...
import (
	...
	"uw/pkg/x/mod/sumdb/note"
	"uw/pkg/x/mod/sumdb/tlog"
)
...
`)
	...
	tc.addRecord("uw/pkg/x/text@v0.0.0-20170915032832-14c0d48ead0c", `uw/pkg/x/text v0.0.0-20170915032832-14c0d48ead0c h1:qgOY6WgZOaTkIIMiVjBQcw93ERBE4m30iBm00nkL0i8=
uw/pkg/x/text v0.0.0-20170915032832-14c0d48ead0c/go.mod h1:NqM8EUOU14njkJ3fqMW+pc6Ldnwhi/IjpwHt7yyuwOQ=
`)
