...
import (
	...
	"uw/pkg/x/mod/module"
	"uw/pkg/x/mod/sumdb/dirhash"
	modzip "uw/pkg/x/mod/zip"
	"uw/pkg/x/tools/txtar"
)
...
func TestVCS(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			m:               module.Version{Path: "uw/pkg/x/crypto", Version: "v0.0.0-20191011191535-87dc89f01550"},
			vcs:             "git",
		...
		{
			m:               module.Version{Path: "uw/pkg/x/net", Version: "v0.0.0-20191014212845-da9a3fd4c582"},
			vcs:             "git",
		...
		{
			m:               module.Version{Path: "uw/pkg/x/sync", Version: "v0.0.0-20190911185100-cd5d95a43a6e"},
			vcs:             "git",
		...
		{
			m:               module.Version{Path: "uw/pkg/x/sys", Version: "v0.0.0-20191010194322-b09406accb47"},
			vcs:             "git",
		...
		{
			m:               module.Version{Path: "uw/pkg/x/tools", Version: "v0.0.0-20191017205301-920acffc3e65"},
			vcs:             "git",
