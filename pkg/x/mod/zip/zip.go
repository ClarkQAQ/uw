...
// The module path must be valid (see [uw/pkg/x/mod/module.CheckPath]).
// The version must be valid and canonical (see
// [uw/pkg/x/mod/module.CanonicalVersion]). The path must have a major
// version suffix consistent with the version (see
// [uw/pkg/x/mod/module.Check]). The part of the file path after the
// "<module>@<version>/" prefix must be valid (see
// [uw/pkg/x/mod/module.CheckFilePath]).
//
