...
[![PkgGoDev](https://pkg.go.dev/badge/uw/pkg/x/tools)](https://pkg.go.dev/uw/pkg/x/tools)

This repository provides the `uw/pkg/x/tools` module, comprising
...
[`uw/pkg/x/tools/gopls`](https://pkg.go.dev/uw/pkg/x/tools/gopls)
...
```
go install uw/pkg/x/tools/cmd/goimports@latest
```
...
uw/pkg/x/tools/benchmark/parse
uw/pkg/x/tools/go/ast/astutil
uw/pkg/x/tools/go/types/typeutil
uw/pkg/x/tools/playground
uw/pkg/x/tools/present
uw/pkg/x/tools/refactor/importgraph
uw/pkg/x/tools/refactor/rename
uw/pkg/x/tools/refactor/satisfy
