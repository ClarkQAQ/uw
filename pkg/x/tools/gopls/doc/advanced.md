...
```sh
GO111MODULE=on go install uw/pkg/x/tools/gopls@vX.Y.Z
```
...
go get -d uw/pkg/x/tools/gopls@master uw/pkg/x/tools@master

go install uw/pkg/x/tools/gopls
```
...
```
$ go install uw/pkg/x/tools/gopls@latest
```
