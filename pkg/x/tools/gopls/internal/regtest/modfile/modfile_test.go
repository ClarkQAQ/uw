...
import (
	...
	"uw/pkg/x/tools/gopls/internal/lsp/tests/compare"
...
func TestInconsistentMod(t *testing.T) {
	const proxy = `
-- uw/pkg/x/mod@v0.7.0/go.mod --
go 1.20
module uw/pkg/x/mod
-- uw/pkg/x/mod@v0.7.0/a.go --
package mod
func AutoQuote(string) string { return ""}
-- uw/pkg/x/mod@v0.9.0/go.mod --
go 1.20
module uw/pkg/x/mod
-- uw/pkg/x/mod@v0.9.0/a.go --
package mod
func AutoQuote(string) string { return ""}
`
	const files = `
...
module a.mod.com
go 1.20
require uw/pkg/x/mod v0.6.0 // yyy
replace uw/pkg/x/mod v0.6.0 => uw/pkg/x/mod v0.7.0
-- a/main.go --
package main
import "uw/pkg/x/mod"
import "fmt"
...
module b.mod.com
go 1.20
require uw/pkg/x/mod v0.9.0 // xxx
-- b/main.go --
package aaa
import "uw/pkg/x/mod"
import "fmt"
