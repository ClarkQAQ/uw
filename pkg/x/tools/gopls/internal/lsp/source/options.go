...
import (
	...
	"uw/pkg/x/tools/go/analysis/passes/atomicalign"
	...
	"uw/pkg/x/tools/go/analysis/passes/deepequalerrors"
	...
	"uw/pkg/x/tools/go/analysis/passes/slog"
	"uw/pkg/x/tools/go/analysis/passes/sortslice"
	...
	"uw/pkg/x/tools/go/analysis/passes/unusedwrite"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/deprecated"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/embeddirective"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/fillreturns"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/fillstruct"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/infertypeargs"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/nonewvars"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/noresultvalues"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/simplifycompositelit"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/simplifyrange"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/simplifyslice"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/stubmethods"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/undeclaredname"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/unusedparams"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/unusedvariable"
	"uw/pkg/x/tools/gopls/internal/lsp/analysis/useany"
	"uw/pkg/x/tools/gopls/internal/lsp/command"
