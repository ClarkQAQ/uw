...
import (
	...
	"uw/pkg/x/tools/gopls/internal/lsp/debug/log"
	"uw/pkg/x/tools/gopls/internal/lsp/protocol"
	"uw/pkg/x/tools/internal/event"
	"uw/pkg/x/tools/internal/event/core"
	"uw/pkg/x/tools/internal/event/export"
	"uw/pkg/x/tools/internal/event/export/metric"
	"uw/pkg/x/tools/internal/event/export/ocagent"
	"uw/pkg/x/tools/internal/event/export/prometheus"
	"uw/pkg/x/tools/internal/event/keys"
	"uw/pkg/x/tools/internal/event/label"
