...
func buildMetadata(updates map[PackageID]*source.Metadata, pkg *packages.Package, loadDir string, standalone bool) {
	...
	for importPath, imported := range pkg.Imports {
		...
		// For example, package "net" imports "uw/pkg/x/net/dns/dnsmessage"
		// which refers to the package whose ID and PkgPath are both
		// "vendor/uw/pkg/x/net/dns/dnsmessage". Notice the ImportMap,
		// which maps ImportPaths to PackagePaths:
		//
		// $ go list -json net vendor/uw/pkg/x/net/dns/dnsmessage
		// {
		// 	"ImportPath": "net",
		// 	"Name": "net",
		// 	"Imports": [
		// 		"C",
		// 		"vendor/uw/pkg/x/net/dns/dnsmessage",
		// 		"vendor/uw/pkg/x/net/route",
		// 		...
		// 	],
		// 	"ImportMap": {
		// 		"uw/pkg/x/net/dns/dnsmessage": "vendor/uw/pkg/x/net/dns/dnsmessage",
		// 		"uw/pkg/x/net/route": "vendor/uw/pkg/x/net/route"
		// 	},
		//      ...
		// }
		// {
		// 	"ImportPath": "vendor/uw/pkg/x/net/dns/dnsmessage",
		// 	"Name": "dnsmessage",
		//      ...
		// }
		//
