...
import (
	...
	"uw/pkg/x/tools/internal/analysisinternal"
	"uw/pkg/x/tools/internal/typesinternal"
)
...
func typesCodeHref(linkTarget string, code typesinternal.ErrorCode) string {
	return source.BuildLink(linkTarget, "uw/pkg/x/tools/internal/typesinternal", code.String())
}
