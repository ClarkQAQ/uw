...
import (
	...
	"uw/pkg/x/tools/godoc"
	"uw/pkg/x/tools/godoc/static"
	"uw/pkg/x/tools/godoc/vfs"
	"uw/pkg/x/tools/godoc/vfs/gatefs"
	"uw/pkg/x/tools/godoc/vfs/mapfs"
	"uw/pkg/x/tools/godoc/vfs/zipfs"
