...
package main // import "uw/pkg/x/tools/cmd/callgraph"
...
import (
	...
	"uw/pkg/x/tools/go/callgraph"
	"uw/pkg/x/tools/go/callgraph/cha"
	"uw/pkg/x/tools/go/callgraph/rta"
	"uw/pkg/x/tools/go/callgraph/static"
	"uw/pkg/x/tools/go/callgraph/vta"
	"uw/pkg/x/tools/go/packages"
	"uw/pkg/x/tools/go/ssa"
	"uw/pkg/x/tools/go/ssa/ssautil"
)
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph uw/pkg/x/tools/cmd/callgraph |
      digraph succs uw/pkg/x/tools/cmd/callgraph.main
`
