...
//
// Bundle uw/pkg/x/net/http2 for inclusion in net/http,
...
//	bundle -o h2_bundle.go -prefix http2 -tags '!nethttpomithttp2' uw/pkg/x/net/http2
//
...
func bundle(src, dst, dstpkg, prefix, buildTags string) ([]byte, error) {
	...
	fmt.Fprintf(&out, "// Code generated by uw/pkg/x/tools/cmd/bundle. DO NOT EDIT.\n")
