...
import (
	...
	"uw/pkg/x/tools/go/analysis/passes/internal/analysisutil"
...
var Analyzer = &analysis.Analyzer{
	...
	URL:      "https://pkg.go.dev/uw/pkg/x/tools/go/analysis/passes/loopclosure",
...
//	g.Go(func() error { ... })
//
// Currently only "uw/pkg/x/sync/errgroup.Group()" is considered.
func goInvoke(info *types.Info, call *ast.CallExpr) ast.Expr {
	if !isMethodCall(info, call, "uw/pkg/x/sync/errgroup", "Group", "Go") {
		return nil
	}
	return call.Args[0]
}
