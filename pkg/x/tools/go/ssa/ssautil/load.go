...
// uw/pkg/x/tools/go/packages.Load function in LoadSyntax or
// LoadAllSyntax mode.
//
...
//
// The packages must have been loaded from source syntax using the
// uw/pkg/x/tools/go/packages.Load function in LoadAllSyntax mode.
//
...
// The mode parameter controls diagnostics and checking during SSA construction.
//
// Deprecated: Use uw/pkg/x/tools/go/packages and the Packages
