...
import (
	...
	"uw/pkg/x/tools/go/buildutil"
	"uw/pkg/x/tools/go/packages/packagestest"
)
...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "uw/pkg/x/tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/uw/pkg/x/tools/go/buildutil/util_test.go",
			"uw/pkg/x/tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/uw/pkg/x/tools/go/buildutil/util_test.go", "uw/pkg/x/tools/go/buildutil"},
			{tmp, gopath + "/src/uw/pkg/x/tools/go/buildutil/util_test.go", "uw/pkg/x/tools/go/buildutil"},
			{tmp, tmp + "/src/uw/pkg/x/tools/go/buildutil/util_test.go", "uw/pkg/x/tools/go/buildutil"},
		}...)
	}
