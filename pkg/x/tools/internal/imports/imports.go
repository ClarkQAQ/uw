...
// Options is uw/pkg/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements uw/pkg/x/tools/imports.Process with explicit context in opt.Env.
