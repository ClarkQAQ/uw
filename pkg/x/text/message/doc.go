...
// 1. Install gotext
//
//	go get -u uw/pkg/x/text/cmd/gotext
//	gotext -help
//
...
// see also package uw/pkg/x/text/message/catalog can be used to implement
...
// uw/pkg/x/text/feature and uw/pkg/x/text/message/catalog for more
// information.
package message
