...
import (
	...
	"uw/pkg/x/text/internal/format"
	"uw/pkg/x/text/internal/number"
	"uw/pkg/x/text/language"
	"uw/pkg/x/text/message/catalog"
)
...
// It implements "uw/pkg/x/text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "uw/pkg/x/text/internal/format".State.
