...
import (
	...
	fmtparser "uw/pkg/x/text/internal/format"
	"uw/pkg/x/tools/go/callgraph"
	"uw/pkg/x/tools/go/callgraph/cha"
	"uw/pkg/x/tools/go/loader"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("uw/pkg/x/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: uw/pkg/x/text/message is not imported")
	}
