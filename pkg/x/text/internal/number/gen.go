...
import (
	...
	"uw/pkg/x/text/internal/language"
	"uw/pkg/x/text/internal/language/compact"
	"uw/pkg/x/text/internal/number"
	"uw/pkg/x/text/internal/stringset"
...
func main() {
	...
	fmt.Fprintln(w, `import "uw/pkg/x/text/internal/stringset"`)
