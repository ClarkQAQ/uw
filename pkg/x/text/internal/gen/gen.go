...
package gen // import "uw/pkg/x/text/internal/gen"
...
const header = `// Code generated by running "go generate" in uw/pkg/x/text. DO NOT EDIT.
...
func localReadmeFile() (string, error) {
	p, err := build.Import("uw/pkg/x/text", "", build.FindOnly)
	if err != nil {
...
const readmeTxt = `Generated by uw/pkg/x/text/internal/gen. DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the uw/pkg/x/text subrepo.
