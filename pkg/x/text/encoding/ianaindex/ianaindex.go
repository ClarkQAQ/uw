...
import (
	...
	"uw/pkg/x/text/encoding/charmap"
	"uw/pkg/x/text/encoding/internal/identifier"
	"uw/pkg/x/text/encoding/japanese"
	"uw/pkg/x/text/encoding/korean"
	"uw/pkg/x/text/encoding/simplifiedchinese"
	"uw/pkg/x/text/encoding/traditionalchinese"
	"uw/pkg/x/text/encoding/unicode"
)
